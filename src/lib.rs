...
/// Type alias for HTTP extensions used in object store operations
///
/// This provides a consistent interface for implementation-specific extensions
/// that can be used to pass context-specific information (like tracing spans)
/// via trait methods.
